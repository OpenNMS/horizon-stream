...
export type ListDevicesQuery = { __typename?: 'Query', listDevices: { __typename?: 'ListDevices', count: string, totalCount: string, offset: string, items: Array<{ __typename?: 'Device', id: string, id_minion: string, name: string, status: string, icmp_latency: string, snmp_uptime: string }> } };
